...
export default function CounterInput(data: CounterInputProps) {
  ...
  return (
    <div className="my-2 flex flex-row items-center justify-center">
      <button
        style="width:50px; height:50px;" className="focus:shadow-outline w-8 rounded bg-gray-500 text-2xl text-white hover:bg-red-rhr focus:outline-none dark:bg-gray-700"
        type="button"
